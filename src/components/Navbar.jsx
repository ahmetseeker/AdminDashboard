...
const Navbar = () => {
  const { activeMenu, setActiveMenu, isClicked, setIsClicked, handleClick, screenSize, setScreenSize, currentColor, cartSettings } = useStateContext();
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <div className='flex'>
        ...
        {isClicked.cart && cartSettings && <Cart/>}
        {isClicked.chat && <Chat/>}

...
const Cart = () => {
  const { currentColor, setCartSettings } = useStateContext();

  return (
    <div className='w-full bg-half-transparent fixed nav-item top-0 right-0'>
      <div className="float-right h-screen bg-white duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] md:w-400 p-8">
        <div className="flex justify-between items-center">
          <p className='font-semibold text-lg'>Shopping Cart</p>
          <button
            type="button"
            onClick={() => setCartSettings(false)}
